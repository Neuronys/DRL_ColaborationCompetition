# I've reused the multi-agent code I've made for project 2
...
# Main changes occur on the following parameters (compared to project 2)
GAMMA = 0.99            # discount factor
TAU = 0.33              # for soft update of target parameters
LR_ACTOR = 1e-4         # learning rate of the actor 

# most of the time using my MacBook on CPU to train both Actor & Critic neural networks
...
class Agent():
    ...
    def __init__(self, state_size, action_size, num_agents, random_seed):
        ...
        # Noise process for multi-agent => size of 2 dimension 
...
class OUNoise():
    ...
    def sample(self):
        ...
        x = self.state
        # experiment various methods to sample the noise
        ...
        # new dx definition found in the slack discussion
